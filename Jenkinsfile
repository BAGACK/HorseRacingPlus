pipeline {
   ...
   stages {
      ...
      stage ('Build') {
          ...
          post {
              failure {
                  mail to: 'mep_eisen@web.de', subject: 'build of HorseRacingPlus failed', body: 'build of HorseRacingPlus failed'
              }
          }
      }
      ...
      stage ('Upload') {
        steps {
            ...
            sh "/srv/hudson/upload_game.sh ${env.BUILDTYPE} target 1 HorseRacingPlus MGHorseRacingPlus-Plugin"
      	}
      }
      ...
      stage ('Deploy') {
          ...
          post {
              failure {
                  mail to: 'mep_eisen@web.de', subject: 'deploy of HorseRacingPlus failed', body: 'deploy of HorseRacingPlus failed'
              }
          }
      }
   }
